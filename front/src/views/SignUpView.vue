<template>
  <div class="signup-page" style="width: 100%; height: 100%; background: #F9EB87; display: flex; justify-content: center; align-items: center; margin-top: 110px;">
    <div class="signup-container" style="width: 800px; background: #FBF9F4; padding: 40px; border-radius: 20px; box-shadow: 6px 9px 4px rgba(0, 0, 0, 0.2);">
      <h1 style="color: #585547; font-size: 40px; font-family: 'IBM Plex Sans KR', sans-serif; font-weight: 700; margin-bottom: 10px; margin-top: -5px;">회원가입</h1>
      ...
      <div style="text-align: center; margin-top: 30px; margin-bottom: -10px;">
        <button class ='action-button' @click="handleSubmit" style="padding: 10px 20px; background: #E6AF69; color: #FBF9F4; border: none; border-radius: 15px; font-size: 18px; font-family: 'IBM Plex Sans KR', sans-serif; font-weight: 700; cursor: pointer;">
          회원가입 하기
        </button>
      </div>
    </div>
